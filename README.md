...
```javascript
iterAvercos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-avercos@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-avercos@v0.2.0-umd/browser.js"></script>
```
